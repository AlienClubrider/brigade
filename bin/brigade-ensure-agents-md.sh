...
# This is a worktree utility for line cooks, not a supervision script, so it does
# not call brigade-guard.sh.
# Usage: brigade-ensure-agents-md.sh [repo-or-worktree-dir]
set -eu

usage() {
  echo "usage: brigade-ensure-agents-md.sh [repo-or-worktree-dir]" >&2
}
